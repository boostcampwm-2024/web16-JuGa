    ...
    return (
      <thead className={'sticky top-0 z-10 bg-white'}>
        <tr className={'h-10 border-b text-gray-500'}>
          ...
          <th className={'px-4 py-2 text-right font-medium'}>종가</th>
          <th className={'px-4 py-2 text-right font-medium'}>등락률</th>
          <th className={'px-4 py-2 text-right font-medium'}>거래량(주)</th>
          <th className={'px-4 py-2 text-right font-medium'}>거래대금</th>
          <th className={'px-4 py-2 text-right font-medium'}>시가</th>
          <th className={'px-4 py-2 text-right font-medium'}>고가</th>
          <th className={'px-4 py-2 text-right font-medium'}>저가</th>
        </tr>
      </thead>
    );
  }
