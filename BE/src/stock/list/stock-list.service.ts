...
export class StockListService {
  ...
  private toResponseDto(stock: Stocks): StockResponseDto {
    return new StockResponseDto(stock.code, stock.name, stock.market);
  }
  ...
  async search(params: SearchParams): Promise<StockResponseDto[]> {
